...
#ifndef SLAMBOX_SDK_INCLUDE_SBOX_PROTOCOL_SET_SET_SERIAL_COMMUNICATION_CONFIG_HPP_
#define SLAMBOX_SDK_INCLUDE_SBOX_PROTOCOL_SET_SET_SERIAL_COMMUNICATION_CONFIG_HPP_
