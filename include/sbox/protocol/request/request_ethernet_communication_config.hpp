...
#ifndef SLAMBOX_SDK_INCLUDE_SBOX_PROTOCOL_REQUEST_REQUEST_ETHERNET_COMMUNICATION_CONFIG_HPP_
#define SLAMBOX_SDK_INCLUDE_SBOX_PROTOCOL_REQUEST_REQUEST_ETHERNET_COMMUNICATION_CONFIG_HPP_
