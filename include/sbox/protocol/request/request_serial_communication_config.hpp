...
#ifndef SLAMBOX_SDK_INCLUDE_SBOX_PROTOCOL_REQUEST_REQUEST_SERIAL_COMMUNICATION_CONFIG_HPP_
#define SLAMBOX_SDK_INCLUDE_SBOX_PROTOCOL_REQUEST_REQUEST_SERIAL_COMMUNICATION_CONFIG_HPP_
