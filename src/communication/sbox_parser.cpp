...
void SBoxParser::parse(vector<uint8_t> data) {
...
void SBoxParser::decapsulate_payload_(const std::array<uint8_t, 2> &mode,
...
bool SBoxParser::is_length_valid_(std::array<uint8_t, 2> mode,
                                  uint16_t length) {
...
void SBoxParser::add_parsed_message_callback(
